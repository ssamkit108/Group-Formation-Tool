...
public class AlgorithmServiceImpl implements AlgorithmService {
	...
	public List<List<String>> groupFormation(Course course) throws UserDefinedSQLException {
		...
		System.out.println(userSurveyResponse);
		
		formatAllResponsesOfAllStudents(userSurveyResponse, formattedResponses);
		
		for (List<Integer> resp : formattedResponses) {
	...
	private List<List<String>> formGroup(List<List<Integer>> formattedResponses, List<String> criteria,
	...
	private void processMultipleChoiceAndFreeTextResponse(List<SurveyQuestionResponse> response) {
		int j = 0;
	...
	private void fetchAllDetailsRegardingSurvey(List<List<SurveyQuestionResponse>> userSurveyResponse, Course course)
	...
	private List<String> getCriteriaList(List<SurveyQuestion> surveyQuestions) {
		int m = 0;
		List<String> criteria = new ArrayList<String>();
	...
	private List<List<Integer>> formatAllResponsesOfAllStudents(List<List<SurveyQuestionResponse>> userSurveyResponse,
