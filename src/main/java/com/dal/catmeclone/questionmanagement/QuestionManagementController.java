...
public class QuestionManagementController {
	...
	public String viewQuestionSortedByTitle(@ModelAttribute ArrayList<BasicQuestion> listOfquestion, Model model)  {
		System.out.println(listOfquestion.toString());
		Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
		String username = authentication.getName();
	    try {
	...
	public String getQuestionBasicDetails(@ModelAttribute("question") BasicQuestion basicQuestion, Model model, RedirectAttributes attributes) {
    ...
    public String addOption(MultipleChoiceQuestion question, HttpServletRequest request,final BindingResult bindingResult, Model model) {
	...
	public String createNumericQuestion(@ModelAttribute("question") BasicQuestion basicQuestion, Model model, RedirectAttributes attributes) {
	...
	public String createMultipleChoiceQuestion(@ModelAttribute("question") MultipleChoiceQuestion multipleChoice, Model model, RedirectAttributes attributes) {
